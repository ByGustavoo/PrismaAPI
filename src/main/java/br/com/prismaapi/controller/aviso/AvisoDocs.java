...
public interface AvisoDocs {
    ...
    @Operation(
            ...
            description = """
                    ...
                    abertas ou fechadas que vencem nos próximos 15 dias, lançamentos pendentes ou agendados \
                    até 15 dias à frente, inclusive os atrasados, e cartões de crédito com 70% ou mais do \
                    limite comprometido.
                    ...
                    da severidade mais alta para a mais baixa e, dentro de cada uma, pela data. Faturas \
                    vencidas não geram aviso, porque o pagamento de fatura não é registrado.""")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
